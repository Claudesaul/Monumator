...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1754778440);
user_pref("app.update.lastUpdateTime.background-update-timer", 1754778440);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1754778440);
user_pref("app.update.lastUpdateTime.region-update-timer", 1754778440);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1754778440);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1754778440);
user_pref("app.update.migrated.updateDir3.689EC2CAD0AE76AD", true);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{1fbb7ead-32bd-4a8e-a63a-11702990d307}");
...
user_pref("browser.startup.lastColdStartupCheck", 1754787719);
...
user_pref("captchadetection.lastSubmission", 1754778);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "4e081b74-fa48-455a-9d70-de525f232902");
user_pref("datareporting.dau.cachedUsageProfileID", "a0bdd335-cb4e-40c9-90a1-d58a27ab5f04");
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECPqLU7yRrK13BAh8GkJqwpgbIQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"5ed4f0e4-a1b7-4c1e-94e3-f1d140996d95\",\"newtab@mozilla.org\":\"64c28c06-8906-4197-8fed-07d4a9f4dda9\",\"pictureinpicture@mozilla.org\":\"21b2c149-c2d8-4560-b3a0-a8578e678de0\",\"addons-search-detection@mozilla.com\":\"8f4e8254-be11-409e-805f-4118656b2d4d\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"17b4fe9e-66f3-408b-9370-b2919dc52db9\",\"firefox-compact-dark@mozilla.org\":\"cebd7e94-9634-43f8-833c-f312819604ba\",\"addon@darkreader.org\":\"36ce5116-77cc-4088-bfb8-82c78e5bbf70\"}");
...
user_pref("nimbus.profileId", "8ce1b283-6f56-4dda-b202-5a91de3ce978");
...
user_pref("sidebar.backupState", "{\"panelOpen\":false,\"launcherWidth\":0,\"launcherExpanded\":false,\"launcherVisible\":false,\"pinnedTabsHeight\":0,\"expandedPinnedTabsHeight\":0,\"collapsedPinnedTabsHeight\":0}");
user_pref("sidebar.main.tools", "aichat,syncedtabs,history,bookmarks");
user_pref("sidebar.revamp", true);
user_pref("sidebar.verticalTabs", true);
user_pref("sidebar.visibility", "hide-sidebar");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBr335ANKdTTBAi4zK3AiYSkPw==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "87c85e13");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1754787717);
